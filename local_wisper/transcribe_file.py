#!/usr/bin/env python3
"""Transcribe an existing WAV file using the application model helpers."""
...
from .cli import AppError, DEFAULT_BACKEND, load_model, transcribe_with_model
from .cli import _default_compute_type, _default_model_name
